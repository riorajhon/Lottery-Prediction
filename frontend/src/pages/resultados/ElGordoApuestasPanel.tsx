...
export function ElGordoApuestasPanel() {
  const [windowKey, setWindowKey] = useState<ApuestasWindow>('3m');
  const { points, loading, error } = useApuestasSeries('el-gordo', windowKey);
  ...
  return (
    <section className="card resultados-apuestas-card">
      <div className="resultados-apuestas-header">
        <h2 style={{ margin: 0, fontSize: '1rem' }}>Gráficos El Gordo</h2>
